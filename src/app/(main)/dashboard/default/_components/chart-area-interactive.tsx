...
export function ChartAreaInteractive() {
  ...
  return (
    <Card className="@container/card">
      <CardHeader>
        <CardTitle>Tren Peringatan Risiko</CardTitle>
        <CardDescription>
          <span className="hidden @[540px]/card:block">5 hari terakhir</span>
          <span className="@[540px]/card:hidden">5 hari terakhir</span>
        </CardDescription>
        <CardAction>
          <ToggleGroup
            type="single"
